...
class PurchaseOrder(models.Model):
    ...
    def do_merge(self, cr, uid, ids, context=None):
        ...
        order_lines_to_move = {}
        for porder in [order for order in self.browse(
                cr, uid, ids, context=context) if order.state == 'draft']:
            ...
            if not order_infos:
                order_infos.update({
                    ...
                    'review': porder.review,
                    'related_segment': porder.related_segment,
            ...
            order_lines_to_move[order_key] += [order_line.id for order_line in
                                               porder.order_line
        ...
        for order_key, (order_data, old_ids) in new_orders.iteritems():
            ...
            self.message_post(cr, uid, [neworder_id], body=_("RFQ created"),
                              context=context)
